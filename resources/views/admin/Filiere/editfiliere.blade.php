    ...
    <body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <main class="main mb-5 p-4">
                ...
                <form id="FiliereForm" action="{{ route('EditFiliere', ['id' => $Filiere->id]) }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="dateInspection" class="form-label">Le nom de la filière</label>
                        <input type="text" name="TitleSector" class="form-control custom-input" id="TitleSector" value="{{ $Filiere->Name }}" required>
                    </div>
