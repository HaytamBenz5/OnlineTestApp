                    ...
                    <section>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="CNI" name="CNI" type="text" class="mt-1 block w-full" :value="old('CNI', $user->CNI)" required autofocus autocomplete="CNI" />
                                <x-input-error class="mt-2" :messages="$errors->get('CNI')" />
                            </div>
